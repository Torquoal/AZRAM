# AZRA - Augmenting Zoomorphic Robots with Affect
...
## Project Overview
AZRA is an interactive robot companion project designed for use with Meta Quest 3 and Unity. The robot responds to hand gestures, voice, and environmental cues, displaying a range of emotional states and behaviors.
